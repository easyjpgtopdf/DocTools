// Vercel Serverless Function - Background Remover V2 Proxy
// Proxies requests to Google Cloud Run backend

const CLOUDRUN_API_URL = process.env.CLOUDRUN_API_URL || 'https://bg-remover-api-v2-564572183797.us-central1.run.app';
