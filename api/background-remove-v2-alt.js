// Vercel Serverless Function - Background Remover V2 Alternative Proxy
// Uses alternative backend (no onnxruntime)

const CLOUDRUN_API_URL = process.env.CLOUDRUN_API_URL_ALT || 'https://bg-remover-api-v2-alt-564572183797.us-central1.run.app';
