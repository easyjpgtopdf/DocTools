...
gcloud run deploy $SERVICE_NAME --image $IMAGE_NAME --platform managed --region $REGION --allow-unauthenticated --memory 512Mi --cpu 1 --concurrency 0 --timeout 540 --min-instances 0 --max-instances 10 --set-env-vars $envVars --project $PROJECT_ID
