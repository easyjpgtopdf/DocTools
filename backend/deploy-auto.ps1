...
$envVars = "PROJECT_ID=$PROJECT_ID,GCS_OUTPUT_BUCKET=$BUCKET_NAME,DOCAI_PROCESSOR_ID=$DOCAI_PROCESSOR_ID,DOCAI_LOCATION=$DOCAI_LOCATION,FIREBASE_PROJECT_ID=$PROJECT_ID"
