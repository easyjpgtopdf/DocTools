...
Write-Host "=== Starting Deployment for PyTorch U2NetP Background Remover ===" -ForegroundColor Green

# --- Configuration ---
$PROJECT_ID = "easyjpgtopdf-de346"
$SERVICE_NAME = "bg-remover-pytorch-u2netp"
$REGION = "us-central1"
$IMAGE_NAME = "gcr.io/$PROJECT_ID/$SERVICE_NAME"
$MEMORY = "4Gi"  # 4GB for PyTorch
...
Write-Host "`nNote: For best quality, download u2netp.pth from official repository" -ForegroundColor Cyan
Write-Host "      https://github.com/xuebinqin/U-2-Net" -ForegroundColor Cyan
